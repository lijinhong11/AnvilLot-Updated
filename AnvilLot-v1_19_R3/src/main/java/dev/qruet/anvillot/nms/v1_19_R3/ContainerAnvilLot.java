...
import dev.qruet.anvillot.bar.v1_19_R3.ExperienceBar;
import dev.qruet.anvillot.bar.v1_19_R3.HardLimitBar;
import dev.qruet.anvillot.bar.v1_19_R3.TooExpensiveBar;
...
public class ContainerAnvilLot extends ContainerAnvil implements IContainerAnvilLot {
    ...
    public void a(EntityHuman entityhuman, ItemStack itemstack) {
        ...
        //Container
        sendSlotUpdate(-1, new ItemStackWrapper(entityhuman.fJ().m.bO.g()), -1, k());
        ...
        this.o.a((world, blockposition) -> {
            ...
            if (!entityhuman.fK().d && iblockdata.a(TagsBlock.G) && entityhuman.dZ().i() < 0.12F) {
    ...
    public void a(String s) {
        ...
        if (!bT && !q.a(0).x().getString().equals(s)) {
            bT = true;
            updateRepairCost(repairCost + 1);
        } else if (bT && q.a(0).x().getString().equals(s)) {
            bT = false;
            updateRepairCost(repairCost - 1);
        }
    }
