...
import dev.qruet.anvillot.bar.v1_20_R4.ExperienceBar;
import dev.qruet.anvillot.bar.v1_20_R4.HardLimitBar;
import dev.qruet.anvillot.bar.v1_20_R4.TooExpensiveBar;
...
public class ContainerAnvilLot extends ContainerAnvil implements IContainerAnvilLot {
    ...
    public void a(EntityHuman entityhuman, ItemStack itemstack) {
        ...
        //Container
        sendSlotUpdate(-1, new ItemStackWrapper(entityhuman.gc().l.ca.g()), -1, k());
        ...
        this.o.a((world, blockposition) -> {
            ...
            if (!entityhuman.gd().d && iblockdata.a(TagsBlock.G) && entityhuman.el().i() < 0.12F) {
                IBlockData iblockdata1 = BlockAnvil.e(iblockdata);
                if (iblockdata1 == null) {
                    world.a(blockposition, false);
                    world.c(1029, blockposition, 0);
                    //getInventory().f
                    entityhuman.gc().f(itemstack);
                } else {
    ...
    public boolean a(String s) {
        ...
        if (!q.a(0).x().getString().equals(s)) {
            b = true;
            updateRepairCost(repairCost + 1);
        } else if (q.a(0).x().getString().equals(s)) {
            b = false;
            updateRepairCost(repairCost - 1);
        }
