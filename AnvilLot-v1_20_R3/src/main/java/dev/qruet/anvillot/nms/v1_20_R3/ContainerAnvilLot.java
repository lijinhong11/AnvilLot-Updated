package dev.qruet.anvillot.nms.v1_20_R3;

import dev.qruet.anvillot.bar.v1_20_R3.ExperienceBar;
import dev.qruet.anvillot.bar.v1_20_R3.HardLimitBar;
import dev.qruet.anvillot.bar.v1_20_R3.TooExpensiveBar;
...
public class ContainerAnvilLot extends ContainerAnvil implements IContainerAnvilLot {
    ...
    public void a(EntityHuman entityhuman, ItemStack itemstack) {
        ...
        //Container
        sendSlotUpdate(-1, new ItemStackWrapper(entityhuman.fS().m.bR.g()), -1, k());

        q.a(0, ItemStack.f);
        if (u.get() > 0) {
            ItemStack itemstack1 = q.a(1);
            //isEmpty && getPopTime
            if (!itemstack1.b() && itemstack1.K() > u.get()) {
                itemstack1.g(u.get());
                q.a(1, itemstack1);
            } else {
                q.a(1, ItemStack.f);
        ...
        this.o.a((world, blockposition) -> {
            ...
            if (!entityhuman.fT().d && iblockdata.a(TagsBlock.G) && entityhuman.eg().i() < 0.12F) {
                IBlockData iblockdata1 = BlockAnvil.e(iblockdata);
                if (iblockdata1 == null) {
                    world.a(blockposition, false);
                    world.c(1029, blockposition, 0);
                    //getInventory().f
                    entityhuman.fS().f(itemstack);
                } else {
    ...
    public boolean a(String s) {
        ...
        if (!q.a(0).y().getString().equals(s)) {
            b = true;
            updateRepairCost(repairCost + 1);
        } else if (q.a(0).y().getString().equals(s)) {
            b = false;
            updateRepairCost(repairCost - 1);
        }
