...
import dev.qruet.anvillot.bar.v1_20_R1.ExperienceBar;
import dev.qruet.anvillot.bar.v1_20_R1.HardLimitBar;
import dev.qruet.anvillot.bar.v1_20_R1.TooExpensiveBar;
...
public class ContainerAnvilLot extends ContainerAnvil implements IContainerAnvilLot {
    ...
    public void a(EntityHuman entityhuman, ItemStack itemstack) {
        ...
        //Container
        sendSlotUpdate(-1, new ItemStackWrapper(entityhuman.fN().m.bQ.g()), -1, k());
        ...
        this.o.a((world, blockposition) -> {
            ...
            if (!entityhuman.fO().d && iblockdata.a(TagsBlock.G) && entityhuman.ec().i() < 0.12F) {
