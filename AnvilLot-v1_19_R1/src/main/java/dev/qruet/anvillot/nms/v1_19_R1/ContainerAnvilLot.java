package dev.qruet.anvillot.nms.v1_19_R1;


import dev.qruet.anvillot.bar.v1_19_R1.ExperienceBar;
import dev.qruet.anvillot.bar.v1_19_R1.HardLimitBar;
import dev.qruet.anvillot.bar.v1_19_R1.TooExpensiveBar;
...
public class ContainerAnvilLot extends ContainerAnvil implements IContainerAnvilLot {
    ...
    public void a(EntityHuman entityhuman, ItemStack itemstack) {
        ...
        //Container
        sendSlotUpdate(-1, new ItemStackWrapper(entityhuman.fA().l.bT.g()), -1, k());

        p.a(0, ItemStack.b);
        if (u.get() > 0) {
            ItemStack itemstack1 = p.a(1);
            //isEmpty && getPopTime
            if (!itemstack1.b() && itemstack1.J() > u.get()) {
                itemstack1.g(u.get());
                p.a(1, itemstack1);
            } else {
                p.a(1, ItemStack.b);
        ...
        this.q.a((world, blockposition) -> {
            ...
            if (!entityhuman.fB().d && iblockdata.a(TagsBlock.G) && entityhuman.dQ().i() < 0.12F) {
                IBlockData iblockdata1 = BlockAnvil.e(iblockdata);
                if (iblockdata1 == null) {
                    world.a(blockposition, false);
                    world.c(1029, blockposition, 0);
                    //getInventory().f
                    entityhuman.fA().f(itemstack);
                } else {
    ...
    public boolean a(EntityHuman entityhuman) {
        return !this.checkReachable || this.q.<Boolean>a((world, blockposition) -> this.a(world.a_(blockposition)) && entityhuman.h((double) blockposition.u() + 0.5D, (double) blockposition.v() + 0.5D, (double) blockposition.w() + 0.5D) <= 64.0D, true);
    }
    ...
    public void a(String s) {
        ...
        if (!bT && !p.a(0).x().getString().equals(s)) {
            bT = true;
            updateRepairCost(repairCost + 1);
        } else if (bT && p.a(0).x().getString().equals(s)) {
            bT = false;
            updateRepairCost(repairCost - 1);
        }
    }
