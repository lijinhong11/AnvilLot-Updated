...
import dev.qruet.anvillot.bar.v1_18_R2.ExperienceBar;
import dev.qruet.anvillot.bar.v1_18_R2.HardLimitBar;
import dev.qruet.anvillot.bar.v1_18_R2.TooExpensiveBar;
...
public class ContainerAnvilLot extends ContainerAnvil implements IContainerAnvilLot {
    ...
    public void a(EntityHuman entityhuman, ItemStack itemstack) {
        ...
        sendSlotUpdate(-1, new ItemStackWrapper(entityhuman.fr().l.bU.g()), -1, k());
        ...
        this.q.a((world, blockposition) -> {
            ...
            if (!entityhuman.fs().d && iblockdata.a(TagsBlock.G) && entityhuman.dL().nextFloat() < 0.12F) {
                IBlockData iblockdata1 = BlockAnvil.e(iblockdata);
                if (iblockdata1 == null) {
                    world.a(blockposition, false);
                    world.c(1029, blockposition, 0);
                    entityhuman.fr().f(itemstack);
                } else {
    ...
    public boolean a(EntityHuman entityhuman) {
        return !this.checkReachable || this.q.<Boolean>a((world, blockposition) -> !this.a(world.a_(blockposition)) ? false : entityhuman.h((double) blockposition.u() + 0.5D, (double) blockposition.v() + 0.5D, (double) blockposition.w() + 0.5D) <= 64.0D, true);
    }
    ...
    public void a(String s) {
        ...
        if (!bT && !p.a(0).w().getString().equals(s)) {
            bT = true;
            updateRepairCost(repairCost + 1);
        } else if (bT && p.a(0).w().getString().equals(s)) {
            bT = false;
            updateRepairCost(repairCost - 1);
        }
    }
